...
public class AboutActivity extends AppCompatActivity {
    ...
    private static final String APP_ABOUT_TEXT = "Songs Player - Modern Online & Offline Music Player\n\n"
            + "Songs Player is a free, ad-free online and offline music player designed for a fast, simple, and seamless audio experience. Easily stream, browse, and manage your songs with a clean interface, smooth performance, and high-fidelity audio at its core.\n\n"
    ...
    private void downloadAppApk() {
        ...
        Executors.newSingleThreadExecutor().execute(() -> {
            try {
                ...
                String fileName = "songs-player-amit-bharat.apk";
                ...
                if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.Q) {
                    ...
                    StorageUtils.copyFile(originalApk, destApk);
                    ...
                    downloadedUri = FileProvider.getUriForFile(this, getPackageName() + ".provider", destApk);
                    success = true;
                }
    ...
    private void shareAppApk() {
        ...
        Executors.newSingleThreadExecutor().execute(() -> {
            try {
                ...
                File targetApk = new File(shareDir, "songs-player-amit-bharat.apk");
                StorageUtils.copyFile(originalApk, targetApk);
                ...
                shareIntent.putExtra(Intent.EXTRA_SUBJECT, "Songs Player APK - by Amit Bharat (Rooys Soft Tech)");
                shareIntent.putExtra(Intent.EXTRA_TEXT, APP_ABOUT_TEXT);
                shareIntent.addFlags(Intent.FLAG_GRANT_READ_URI_PERMISSION);

                runOnUiThread(() -> {
                    startActivity(Intent.createChooser(shareIntent, "Share Songs Player APK & Details"));
                });
            } catch (Exception e) {
                e.printStackTrace();
                runOnUiThread(() -> {
    ...
    private void shareAppDescriptionFallback() {
        ...
        intent.putExtra(Intent.EXTRA_SUBJECT, "Songs Player - Modern Online & Offline Music Player");
        intent.putExtra(Intent.EXTRA_TEXT, APP_ABOUT_TEXT);
        startActivity(Intent.createChooser(intent, "Share Songs Player App"));
    }
    ...
    private void sendFeedbackEmail() {
        ...
        intent.putExtra(Intent.EXTRA_SUBJECT, "Songs Player App - Feedback & Support");
